...
public class ClientAgent extends Agent {
	...
	public void receiveOffer(Offer offer) {
		...
		// XXX: ???
		/*
		 * 3. Na tym obiekcie klasy OfferStatus wykonać odpowiednio:
		 * receiveOffer i reciveRenegotiation - umieszczenie offer i zmianę
		 * stanu na 0x3 receiveRefusal - zmianę stanu na 0x9 reciveContractSign
		 * - zmianę stanu na 0x7
		 */
	}
